...
class KMBot2(Bot):
    ...
    def performAction(self, board):
        ...
        if self.should_i_run(my_position, attacked_fields):
            ...
            return Move(selected_direction)
        return 
			return Shot(choice([ShotDirection.South, ShotDirection.NorthWest, ShotDirection.North, ShotDirection.SouthWest, ShotDirection.East, ShotDirection.NorthEast, ShotDirection.South, ShotDirection.SouthEast]))
