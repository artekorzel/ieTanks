...
public class MissileDestroyed extends AbstractMissileEvent {
    ...
    public MissileDestroyed(int id, String tankId, Position position, Direction direction, int speed) {
        super(MissileAction.DESTROYED, id, tankId, position, direction, speed);
